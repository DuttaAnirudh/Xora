...
const Pricing = () => {
  ...
  const pricingTitleInView = useInView(pricingTitleRef);
  const pricingBoxInView = useInView(pricingBoxRef);
        ...
        <div className="container">
          <div className="max-w-960 pricing-head_before relative mx-auto border-l border-r border-s2 bg-s1/50 pb-40 pt-28 max-xl:max-w-4xl max-lg:border-none max-md:pb-32 max-md:pt-16">
            <motion.h3
              ...
              ref={pricingTitleRef}
              variants={variantPricingTitle}
              initial="initial"
              animate={pricingTitleInView && "animate"}
            >
              Flexible Pricing for teams of all sizes
            </motion.h3>

            <motion.div className="relative z-4 mx-auto flex w-[375px] rounded-3xl border-[3px] border-s4/25 bg-s1/50 p-2 backdrop-blur-[6px] max-md:w-[310px]">
              <button
          ...
          <motion.div
            ...
            variants={variantPricingBox}
            initial="initial"
            animate={pricingBoxInView && "animate"}
          >
            {pricingPlans.map((plan, i) => {
              ...
              return (
                ...
                >
                  ...
                  <div
                    className={clsx(
                      "absolute left-0 right-0 z-2 flex items-center",
