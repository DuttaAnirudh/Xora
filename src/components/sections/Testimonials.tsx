...
const Testimonials = () => {
  const halfTestimonialsLength = Math.floor(testimonials.length / 2);

  return (
    <section className="relative z-2 pt-24 md:py-28 lg:py-40">
      <div className="container block lg:flex">
        ...
        <div className="testimonials_inner-after testimonials_inner-before relative -my-12 -mr-3 flex items-start max-lg:static max-md:block">
          <div className="testimonials_group-after flex-50">
            {testimonials
              .slice(0, halfTestimonialsLength)
              .map((testimonial) => (
                <TestimonialItem
                  key={testimonial.id}
          ...
          <div className="flex-50">
            {testimonials.slice(halfTestimonialsLength).map((testimonial) => (
              <TestimonialItem
                key={testimonial.id}
                testimonial={testimonial}
